    ...
    <section className="bg-gray-200 min-h-screen py-8 pt-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-orange-600">All Available Jobs</h1>
          <button
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <aside className={`w-full lg:w-1/4 bg-white p-6 border-r border-gray-300 rounded-lg shadow-md mb-8 lg:mb-0 ${showFilters ? 'block' : 'hidden lg:block'}`}>
            ...
            <button
              ...
              className="w-full bg-orange-500 text-white px-4 py-2 rounded hover:bg-orange-500 transition duration-300 mt-4"
            >
              Apply Filters
            </button>
          </aside>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              {filteredJobs.map((element) => (
                <div key={element._id} className="border-b m-4 border-gray-300  p-6 hover:bg-gray-50">
                  ...
                  <Link
                    to={`/job/${element._id}`}
                    className="inline-block bg-orange-500 text-white px-4 py-2 rounded hover:bg-orange-500 transition duration-300"
                  >
                    View Job Details
                  </Link>
                </div>
