    ...
    <div className="bg-white text-black py-20 font-poppins">
      <div className="container mx-auto flex flex-col items-center text-center px-4">
        <div className="title mb-10 pt-32">
          <h1 className="text-7xl font-extrabold text-orange-500">Find a job that suits</h1>
          <h1 className="text-7xl font-extrabold text-orange-500 ">your interests and skills</h1>
      ...
      <div className="details grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-36">
        {details.map((element) => (
          ...
          >
            <div className="icon text-4xl mb-4 text-orange-500">{element.icon}</div>
            <div className="content text-center">
              <p className="text-2xl font-bold text-orange-400">{element.title}</p>
